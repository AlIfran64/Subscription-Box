...
const Banner = () => {
  return (
    ...
    >
      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg">Handpicked, seasonal produce delivered fresh to your door.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg">Freshikart brings you organic fruits & veggies every week.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            ...
            <p className="mb-8 text-lg">No queues, no hassle. Just freshness, every time.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          <img src="../../../images/slider-4.jpg" alt="slider-3 image" />

          {/* Left-to-right black gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-4 text-start">Premium Quality and <br />Pocket-Friendly Price.</h2>
            <p className="mb-8 text-lg">Enjoy farm-fresh ingredients without breaking the bank.</p>
      ...
      <SwiperSlide>
        <div className="relative w-full">
          <img src="../../../images/slider-5.webp" alt="slider-3 image" />

          {/* Left-to-right black gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent flex flex-col justify-center items-start text-white px-20">
            <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-4 text-start">Fresh Food, Zero Waste.</h2>
            <p className="mb-8 text-lg">Our eco-packaging and smart delivery help the planet.</p>
