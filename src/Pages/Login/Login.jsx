...
const Login = () => {
  const { userLogin, setUser, googleLogin, userForgotPassword } = useContext(AuthContext);
  ...
  const handleForgetPassword = () => {
    const newEmail = emailRef.current?.value; // optional chaining for safety
    ...
    userForgotPassword(newEmail).then(() => {
          ...
          <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
            <div className="card-body">
              ...
              <form onSubmit={handleLogin}>
                ...
                <input type="email" ref={emailRef} name='email' className="input mb-4 w-full" placeholder="Email" />
